...
<head>
    ...
    <base href="/adminlte/">
    <link rel="shortcut icon" href="<?=PATH;?>/images/f2.png" type="image/png" />
    <?=$this->getMeta();?>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?=ADMIN;?>" class="logo">
            ...
            <span class="logo-mini"><b></b>POP</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Funko</b>Pop</span>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="<?=PATH;?>" target="_blank" class="btn btn-default btn-flat">Магазин</a>
                                </div>
                                <div class="pull-right">
                                    <a href="<?=PATH;?>/user/logout" class="btn btn-default btn-flat">Выход</a>
                                </div>
                            </li>
                        </ul>
                    </li>
